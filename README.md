...
All metrics scored 0.0–1.0. **Claude Haiku** is used as the judge — fast and cheap for evaluation.
...
| **Generation** | Anthropic Claude Sonnet 4.6 (streaming SSE) |
| **Evaluation** | Claude Haiku 4.5 as RAGAS judge |
...
**Why Claude Haiku for RAGAS?**  
Haiku is 10x cheaper than Sonnet and evaluation doesn't need creative reasoning — just structured JSON scoring. Keeps eval cost low even at scale.
